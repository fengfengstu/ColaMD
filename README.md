...
- v2.1.0: Tabs: keep several documents open in one window, each with its own undo history, unsaved state and scroll position. Plus fixes for saving landing in the wrong tab's file, caret clicks below the text, and a scrollbar on empty documents
